...
-(NSString*)Tonianyueri
{
    ...
    NSString*Tonianyueri=[NSString stringWithFormat:@"%04ld年%02ld月",dateComponent.year, dateComponent.month];
    return Tonianyueri;
}
-(NSString*)toDay
{
    ...
    NSString *toDay = [date compareIfTodayWithDate];
    return toDay;
}
//返回星期
- (NSString *)getWeek
